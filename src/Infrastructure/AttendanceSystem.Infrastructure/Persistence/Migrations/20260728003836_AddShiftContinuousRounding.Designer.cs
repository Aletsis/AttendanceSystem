...
namespace AttendanceSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260728003836_AddShiftContinuousRounding")]
    partial class AddShiftContinuousRounding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Aggregates.DailyAttendanceAggregate.DailyAttendance", b =>
                {
                    ...
                    b.Property<bool>("HasTemporaryExits")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<int>("LunchBreakMinutesApplied")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int>("RoundingInterval")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<bool>("RoundingsEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<int>("TemporaryExitMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<string>("TemporaryExitNote")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<int>("TemporaryExitStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("AttendanceSystem.Domain.Aggregates.SystemConfigurationAggregate.SystemConfiguration", b =>
                {
                    ...
                    b.Property<bool>("AutoDownloadOnlyToday")
                        .HasColumnType("boolean");
